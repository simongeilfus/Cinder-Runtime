...
public:
	...
	void* operator new( size_t size )
	{
		...
		rt::ClassWatcher<Clear>::instance().watch( static_cast<Clear*>( ptr ), "Clear", { headerPath }, CI_RT_INTERMEDIATE_DIR / "runtime/Clear/build/Clear.dll", rt::Compiler::BuildSettings().default().define( "RT_COMPILED" ).include( "../../../include" ) );
		return ptr;
	}
