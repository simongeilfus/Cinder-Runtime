...
#define RT_WATCH_IMPL( ... ) __RT_WATCH_IMPL_SWITCH(__VA_ARGS__,__RT_WATCH_IMPL3,__RT_WATCH_IMPL2,__RT_WATCH_IMPL1)(__VA_ARGS__)
#define RT_WATCH_INLINE( ... ) __RT_WATCH_INLINE_SWITCH(__VA_ARGS__,__RT_WATCH_INLINE2,__RT_WATCH_INLINE1)(__VA_ARGS__)
#define RT_WATCH_IMPL_SETTINGS( ... ) __RT_WATCH_IMPL2( __VA_ARGS__ )
